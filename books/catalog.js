/*
 * Add a book by duplicating one of the folders in /books and adding an entry here.
 * `glow` accepts any CSS color. Prefer OKLCH so lightness and chroma stay predictable.
 */
window.AfterglowBooks = [
  {
    id: "the-creative-act",
